...
const TrustedLocalExpertise = () => {
  return (
    <section className="py-16 bg-[#f05a27] relative before:absolute before:content-[''] before:w-full before:h-16 before:-top-16 before:left-0 before:bg-[#f05a27] before:transform before:-scale-y-100">
