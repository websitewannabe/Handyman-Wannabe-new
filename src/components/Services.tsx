                    ...
                    {services
                      ...
                      ?.items.map((item, index) => (
                        <motion.div
                          ...
                          className="group relative bg-gray-50 rounded-lg p-6 hover:bg-primary/5 transition-all duration-300 hover:shadow-lg flex flex-col h-[280px]"
                        >
                          ...
                          <div className="mt-auto">
                            <Link
                              ...
                              className="block w-full bg-white border-2 border-primary text-primary font-medium py-3 rounded-lg hover:bg-primary hover:text-white transition-all duration-300 group-hover:shadow-md text-center text-sm md:text-base"
