                ...
                {serviceAreas.map((region, index) => (
                  ...
                  >
                    <div className="flex items-center mb-3">
                      ...
                      <h3 className="text-xl font-bold text-[#5d4037]">{region.region}</h3>
                    </div>
                    <div className="flex flex-wrap gap-2">
                      {region.areas.map((area, areaIndex) => (
                        <motion.span
                          ...
                          whileInView={{ opacity: 1, y: 0 }}
                          viewport={{ once: true }}
                          transition={{ duration: 0.4, delay: (index * 0.2) + (areaIndex * 0.1) }}
      ...
      <section className="py-20 bg-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl font-bold text-white mb-4">Trusted Local Expertise</h2>
            <p className="text-xl text-white/90">Serving the Greater Colorado Springs Area since 2018</p>
          </motion.div>
          ...
          >
            <p className="text-white/90 text-lg">
              Our team of certified professionals brings decades of combined experience to every project, ensuring quality workmanship and exceptional service.
            </p>
          </motion.div>
        </div>
      </section>
