...
const poolsSpasServices = servicesData.filter(
  (service) => service.category === "Pools & Spas",
);

// Group services by subcategory
const groupedServices = poolsSpasServices.reduce(
  (acc, service) => {
    ...
    <div className="relative">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        <div
          ...
          style={{
            backgroundImage: 'url("/images/pool.avif")',
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto mt-16">
          ...
          >
            Keep your pool and spa in pristine condition with expert
            maintenance, repairs, and cleaning services. Our professionals
            ensure crystal-clear water and fully functional equipment
            year-round.
          </motion.p>
          <motion.button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              >
                <h2 className="text-3xl font-bold mb-6 text-[#1B4332]">
                  Expert Pools & Spas Services
                </h2>
                <p className="text-xl text-gray-800 mb-6">
                  Handyman Wannabe provides professional pool and spa services
                  to keep your water sparkling clean and your systems running
                  smoothly. Whether you need routine cleaning, equipment
                  repairs, or seasonal maintenance, our experienced technicians
                  deliver high-quality service with attention to detail.
                </p>
                <p className="text-lg text-gray-700">
                  With certified professionals and advanced equipment, we ensure
                  your pool or spa remains a safe and enjoyable oasis.
                </p>
              </motion.div>
            </div>
          </div>
                  ...
                  >
                    ...
                    >
                      <div className="relative h-48">
                        <img
                          src={services[0]?.image || "public/images/pool.avif"}
                          alt={info.title}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Get your pool and spa services done in just a few simple steps.
            ...
            {[
              {
                ...
                answer:
                  "We recommend weekly or biweekly cleanings to maintain optimal water quality. The frequency may vary based on usage, environment, and season.",
              },
              {
                question: "Can you repair my pool pump or heater?",
                answer:
                  "Yes, we service and repair most pool pumps, motors, and heating systems. Our technicians are trained to work with all major brands and models.",
              },
              {
                question: "How do I know if my pool has a leak?",
                answer:
                  "Signs include consistently low water levels, wet spots around the pool, or unexpected increases in water bills. We can perform leak detection tests to identify the source.",
              },
              {
                question: "Do you winterize pools for the off-season?",
                answer:
                  "Yes, we offer comprehensive winterization services including cleaning, chemical balancing, lowering water levels, and installing winter covers to protect your pool.",
              },
              {
                question: "What chemicals do you use for pool maintenance?",
                answer:
                  "We use industry-standard, safe chemicals for pool sanitation and maintenance. Our technicians carefully balance chemicals to ensure safe swimming conditions.",
              },
            ].map((faq, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">
            Ready to Maintain Your Pool or Spa?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get expert pool and spa services from our skilled professionals.
