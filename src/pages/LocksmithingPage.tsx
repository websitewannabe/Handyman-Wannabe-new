...
import { Star, Lock, Shield, ThumbsUp, Phone, MessageSquare, ChevronDown, ChevronUp, ClipboardList, UserCheck, Calendar, ChevronRight, Key, DoorOpen, Wrench, Settings, PenTool as Tool } from 'lucide-react';
...
const locksmithingServices = servicesData.filter(service => service.category === 'Locksmithing');

// Group services by subcategory
const groupedServices = locksmithingServices.reduce((acc, service) => {
    ...
    <div className="relative">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        <div 
          ...
          style={{
            backgroundImage: 'url("https://images.unsplash.com/photo-1622372738946-62e02505feb3?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80")',
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto mt-16">
          ...
          >
            Professional locksmith services for homes and businesses. From lock installation to security upgrades, our expert technicians ensure your property remains secure.
          </motion.p>
          <motion.button
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              <motion.div
                ...
                transition={{ delay: 0.2 }}
              >
                <h2 className="text-3xl font-bold mb-6 text-[#1B4332]">Expert Locksmithing Services</h2>
                <p className="text-xl text-gray-800 mb-6">
                  Handyman Wannabe provides professional locksmith services to enhance the security of your property. From basic lock repairs to advanced security solutions, our certified locksmiths deliver reliable service with attention to detail.
                </p>
                <p className="text-lg text-gray-700">
                  With experienced professionals and state-of-the-art tools, we ensure your locks and security systems function perfectly.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16">Our Locksmithing Services</h2>
                ...
                >
                  ...
                  >
                    <div className="relative h-48">
                      <img
                        src={services[0]?.image || "https://images.unsplash.com/photo-1622372738946-62e02505feb3?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"}
                        alt={info.title}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Get your locksmith services done in just a few simple steps. Professional service, guaranteed satisfaction.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                answer: "Yes, we provide 24/7 emergency locksmith services for lockouts, broken keys, and other urgent security needs. Our team responds quickly to ensure you regain access to your property."
              },
              {
                question: "Can you rekey locks instead of replacing them?",
                answer: "Yes, rekeying is often a cost-effective alternative to full lock replacement. We can rekey your existing locks to work with new keys while maintaining security."
              },
              {
                question: "Do you work with smart locks and electronic security systems?",
                answer: "Yes, we install and service a wide range of smart locks and electronic security systems, including keypad locks, biometric systems, and smartphone-controlled locks."
              },
              {
                question: "Are your locksmiths certified and insured?",
                answer: "Yes, all our locksmiths are fully certified, licensed, and insured. We maintain strict professional standards and stay updated with the latest security technologies."
              },
              {
                question: "Can you make duplicate keys for all types of locks?",
                answer: "We can duplicate most types of keys, including high-security keys, transponder keys, and restricted keyways. Some specialized or patented keys may require authorization from the manufacturer."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">Need a Professional Locksmith?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get expert locksmith services from our skilled professionals. Contact us today for a free quote!
          </p>
