        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto text-center">
            <motion.div
              ...
              transition={{ delay: 0.2 }}
            >
              <h2 className="text-4xl font-bold mb-8 text-[#1B4332]">Coming Soon!</h2>
              <p className="text-2xl text-gray-800 mb-6">
                Our comprehensive Home Inspection Services overview is currently under development.
              </p>
              <p className="text-xl text-gray-700">
                Please check back soon or contact us directly for more information about our home inspection offerings.
              </p>
              <div className="mt-12">
                <a
                  href="tel:7193156628"
                  className="inline-flex items-center text-xl font-bold bg-primary text-white px-8 py-4 rounded-lg hover:bg-primary/90 transition-colors"
                >
                  <Phone className="w-5 h-5 mr-2" />
                  Call Us Now: (719) 315-6628
                </a>
              </div>
            </motion.div>
          </div>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100">
                    ...
                    <p className="text-primary font-medium">{service.bestFor}</p>
                  </div>
                </div>
              </motion.div>
            ))}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              ...
              {
                question: "What should I do if the inspection reveals issues?",
                answer: "Don't panic! Most homes have some issues. We prioritize findings by severity and provide recommendations for repairs. You can use our report to negotiate repairs with sellers or plan your maintenance schedule."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
              ...
              >
                ...
                <div className={`px-6 pb-6 transition-all duration-300 ${expandedFaq === index ? 'block' : 'hidden'}`}>
                  <p className="text-gray-600">{faq.answer}</p>
                </div>
              </motion.div>
            ))}
