...
import { Star, Brush, Shield, ThumbsUp, Phone, MessageSquare, ChevronDown, ChevronUp, ClipboardList, UserCheck, Calendar, ChevronRight, Home, Trash2, Building2, Sparkles, Bed, Briefcase, Box, Truck, Warehouse, Package, Sofa, Caravan, Plane, Heart } from 'lucide-react';
...
const cleaningServices = servicesData.filter(service => service.category === 'Cleaning');

// Group services by subcategory
const groupedServices = cleaningServices.reduce((acc, service) => {
    ...
    <div className="relative">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto mt-16">
          ...
          >
            Professional cleaning services for homes and businesses. From routine housekeeping to specialized cleanouts, our experts ensure spotless and hygienic spaces.
          </motion.p>
          <motion.button
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              <motion.div
                ...
                transition={{ delay: 0.2 }}
              >
                <h2 className="text-3xl font-bold mb-6 text-[#1B4332]">Expert Cleaning Services</h2>
                <p className="text-xl text-gray-800 mb-6">
                  Handyman Wannabe provides high-quality cleaning services to keep your home or business looking its best. Whether you need a one-time deep clean, recurring maid services, or post-construction cleanup, our skilled team delivers reliable and detailed service.
                </p>
                <p className="text-lg text-gray-700">
                  With trained professionals and eco-friendly cleaning solutions, we ensure your space is clean, fresh, and healthy.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16">Our Cleaning Services</h2>
                ...
                >
                  ...
                  >
                    <div className="relative h-48">
                      <img
                        src={services[0]?.image || "https://images.unsplash.com/photo-1581141849291-1125c7b692b5?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"}
                        alt={info.title}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Get your cleaning services done in just a few simple steps. Professional service, guaranteed satisfaction.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                answer: "No, we bring all necessary cleaning equipment and supplies. We use professional-grade products that are both effective and eco-friendly."
              },
              {
                question: "How often should I schedule cleaning services?",
                answer: "We offer weekly, biweekly, monthly, and one-time cleaning services. The frequency depends on your needs, lifestyle, and the size of your space."
              },
              {
                question: "Are your cleaning products pet- and child-safe?",
                answer: "Yes, we use eco-friendly, non-toxic cleaning solutions that are safe for children, pets, and the environment. We can also accommodate specific product preferences."
              },
              {
                question: "Do you offer same-day or emergency cleaning?",
                answer: "Yes, we provide same-day cleaning services based on availability. Contact us for emergency or urgent cleaning needs."
              },
              {
                question: "Can I customize my cleaning service?",
                answer: "Yes, we tailor our cleaning plans based on your specific needs and preferences. You can choose which areas to focus on and any special requirements."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get expert cleaning services from our skilled professionals. Contact us today for a free quote!
          </p>
