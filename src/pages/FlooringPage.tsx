...
import { Star, Ruler, Shield, ThumbsUp, Phone, MessageSquare, ChevronDown, ChevronUp, ClipboardList, UserCheck, Calendar, ChevronRight, Hammer, Brush, Grid, Car as Carpet, Wrench, Droplet } from 'lucide-react';
...
const flooringServices = servicesData.filter(service => service.category === 'Flooring');

// Group services by subcategory
const groupedServices = flooringServices.reduce((acc, service) => {
...
const FlooringPage = () => {
  ...
  const subcategoryInfo = {
    'hardwood-laminate-flooring': {
      ...
      description: 'Professional installation and repair of hardwood and laminate floors.',
      icon: Hammer
    },
    'vinyl-tile-flooring': {
    ...
    <div className="relative">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        <div 
          ...
          style={{
            backgroundImage: 'url("https://images.unsplash.com/photo-1581858726788-75bc0f6a952d?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80")',
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto mt-16">
          ...
          >
            Professional flooring installation and repairs for your home and business. Whether you need hardwood, laminate, or tile, our experts deliver seamless results.
          </motion.p>
          <motion.button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              >
                <iframe
                  ...
                  title="Flooring Services Overview"
              ...
              <motion.div
                ...
                transition={{ delay: 0.2 }}
              >
                <h2 className="text-3xl font-bold mb-6 text-[#1B4332]">Expert Flooring Services</h2>
                <p className="text-xl text-gray-800 mb-6">
                  Handyman Wannabe provides expert flooring services to enhance the beauty and durability of your space. Whether you're looking to install new floors, repair damaged ones, or refinish existing surfaces, our team ensures high-quality craftsmanship and attention to detail.
                </p>
                <p className="text-lg text-gray-700">
                  With skilled professionals and premium materials, we deliver lasting results that transform your space.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16">Our Flooring Services</h2>
                ...
                >
                  ...
                  >
                    <div className="relative h-48">
                      <img
                        src={services[0]?.image || "https://images.unsplash.com/photo-1581858726788-75bc0f6a952d?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"}
                        alt={info.title}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Get your flooring project done in just a few simple steps. Professional service, guaranteed satisfaction.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                answer: "Luxury Vinyl Plank (LVP) and tile are excellent options for high-traffic areas due to their durability and easy maintenance. We can help you choose the best option based on your specific needs."
              },
              {
                question: "Can you install flooring over my existing floors?",
                answer: "Yes, depending on the type of flooring and condition of your existing surface, we can often install new flooring over existing floors. We'll assess your current flooring during consultation."
              },
              {
                question: "Do you offer eco-friendly flooring options?",
                answer: "Yes, we install sustainable flooring materials like bamboo, cork, and reclaimed wood. We can discuss various eco-friendly options that match your style and budget."
              },
              {
                question: "How long does hardwood floor refinishing take?",
                answer: "Most refinishing projects take 2-3 days, depending on the size of the area and drying time between coats. We'll provide a specific timeline during consultation."
              },
              {
                question: "Can you match new flooring to my existing floors?",
                answer: "Yes, we can match or blend new flooring with existing surfaces for a seamless look. We'll help you select materials that complement your current flooring."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">Ready to Transform Your Floors?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get expert flooring services from our skilled professionals. Contact us today for a free quote!
          </p>
