...
import { Star, Sofa, Shield, ThumbsUp, Phone, MessageSquare, ChevronDown, ChevronUp, ClipboardList, UserCheck, Calendar, ChevronRight, Bed, Umbrella, Baby, Dumbbell, Package, Briefcase } from 'lucide-react';
...
const furnitureAssemblyServices = servicesData.filter(service => service.category === 'Furniture Assembly');

// Group services by subcategory
const groupedServices = furnitureAssemblyServices.reduce((acc, service) => {
...
const FurnitureAssemblyPage = () => {
  ...
  const subcategoryInfo = {
    ...
    'storage-organization-systems': {
      ...
      description: 'Installation of storage solutions and organization systems.',
      icon: Package
    },
    'miscellaneous-assembly-services': {
      title: 'Miscellaneous Assembly Services',
      description: 'Assembly services for various furniture and equipment types.',
      icon: Briefcase
    }
  };
    ...
    <div className="relative">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        <div 
          ...
          style={{
            backgroundImage: 'url("https://images.unsplash.com/photo-1581428982868-e410dd047a90?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80")',
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto mt-16">
          ...
          >
            Professional furniture assembly services for homes and businesses. From IKEA furniture to custom installations, our experts ensure sturdy and reliable setups.
          </motion.p>
          <motion.button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              >
                <iframe
                  ...
                  title="Furniture Assembly Services Overview"
              ...
              <motion.div
                ...
                transition={{ delay: 0.2 }}
              >
                <h2 className="text-3xl font-bold mb-6 text-[#1B4332]">Expert Furniture Assembly</h2>
                <p className="text-xl text-gray-800 mb-6">
                  Handyman Wannabe provides expert furniture assembly services, ensuring your furniture is built securely and efficiently. Whether you need help assembling a new bed frame, office desk, or patio set, our skilled professionals make the process stress-free.
                </p>
                <p className="text-lg text-gray-700">
                  With years of experience and attention to detail, we ensure every piece is assembled correctly and safely for long-lasting use.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16">Our Assembly Services</h2>
                ...
                >
                  ...
                  >
                    <div className="relative h-48">
                      <img
                        src={services[0]?.image || "https://images.unsplash.com/photo-1581428982868-e410dd047a90?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"}
                        alt={info.title}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Get your furniture assembly done in just a few simple steps. Professional service, guaranteed satisfaction.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                answer: "No, our technicians bring all the necessary tools and equipment needed for assembly. We ensure professional-grade tools are used for the best results."
              },
              {
                question: "Can you secure furniture to the wall for safety?",
                answer: "Yes, we install anti-tip hardware to secure bookshelves, dressers, and other heavy furniture to prevent accidents, especially important in homes with children."
              },
              {
                question: "How long does furniture assembly take?",
                answer: "Assembly time varies depending on the complexity of the item. Most pieces take between 30 minutes to 2 hours, but we'll provide a specific time estimate before starting."
              },
              {
                question: "Do you assemble all brands of furniture?",
                answer: "Yes, we assemble furniture from IKEA, Wayfair, Amazon, Walmart, and all major retailers. Our experienced technicians are familiar with a wide range of furniture brands and styles."
              },
              {
                question: "Do you offer disassembly services?",
                answer: "Yes, we can disassemble furniture for moving, storage, or reassembly in another location. We ensure careful handling to prevent damage during the process."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">Need Furniture Assembly Help?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get expert furniture assembly services from our skilled professionals. Contact us today for a free quote!
          </p>
