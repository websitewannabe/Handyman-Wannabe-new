...
import { Star, Flower2, Shield, ThumbsUp, Phone, MessageSquare, ChevronDown, ChevronUp, ClipboardList, UserCheck, Calendar, ChevronRight, Trees, Scissors, Shovel, Fence, Droplet, Trash2, Umbrella } from 'lucide-react';
...
const landscapingServices = servicesData.filter(service => service.category === 'Landscaping');

// Group services by subcategory
const groupedServices = landscapingServices.reduce((acc, service) => {
...
const LandscapingPage = () => {
  ...
  const subcategoryInfo = {
    'general-yard-maintenance': {
      ...
      description: 'Maintain a well-kept lawn and garden with regular yard care.',
      icon: Flower2
    },
    ...
    <div className="relative">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        <div 
          ...
          style={{
            backgroundImage: 'url("https://images.unsplash.com/photo-1558904541-efa843a96f01?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80")',
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto mt-16">
          ...
          >
            Transform your outdoor space with expert landscaping services. From lawn maintenance to garden enhancements, our team delivers beautiful and functional landscapes.
          </motion.p>
          <motion.button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              >
                <iframe
                  ...
                  title="Landscaping Services Overview"
              ...
              <motion.div
                ...
                transition={{ delay: 0.2 }}
              >
                <h2 className="text-3xl font-bold mb-6 text-[#1B4332]">Expert Landscaping Services</h2>
                <p className="text-xl text-gray-800 mb-6">
                  Handyman Wannabe provides professional landscaping services to keep your outdoor spaces looking their best year-round. Whether you need routine lawn care, hardscape repairs, or seasonal cleanups, our team ensures your yard is healthy, neat, and inviting.
                </p>
                <p className="text-lg text-gray-700">
                  With experienced landscaping professionals and attention to detail, we help create and maintain beautiful outdoor spaces you'll love to enjoy.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16">Our Landscaping Services</h2>
                ...
                >
                  ...
                  >
                    <div className="relative h-48">
                      <img
                        src={services[0]?.image || "https://images.unsplash.com/photo-1558904541-efa843a96f01?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"}
                        alt={info.title}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Get your landscaping projects done in just a few simple steps. Professional service, guaranteed satisfaction.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                answer: "For best results, we recommend weekly or biweekly mowing depending on grass growth and season. We'll help you determine the optimal schedule based on your lawn's specific needs."
              },
              {
                question: "Do you provide seasonal yard cleanups?",
                answer: "Yes, we offer comprehensive fall and spring cleanup services, including leaf removal, debris clearing, and preparing your yard for the changing seasons."
              },
              {
                question: "Can you install a garden bed for me?",
                answer: "Yes, we install and set up raised garden beds, including soil preparation and planting. We can help you choose the right location and design for optimal growth."
              },
              {
                question: "Do you repair sprinkler systems?",
                answer: "Yes, we handle basic sprinkler repairs including head replacement, pressure adjustment, and system troubleshooting to ensure proper coverage and efficiency."
              },
              {
                question: "Do I need to be home for the landscaping service?",
                answer: "No, as long as we have access to the area, we can complete the job while you're away. We'll provide detailed updates and photos of the completed work."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get expert landscaping services from our skilled professionals. Contact us today for a free quote!
          </p>
