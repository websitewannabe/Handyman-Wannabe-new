...
import { Star, Hammer, Shield, ThumbsUp, Phone, MessageSquare, ChevronDown, ChevronUp, ClipboardList, UserCheck, Calendar, ChevronRight, Ruler, Wrench, DoorOpen, PenTool as Tool, Sofa } from 'lucide-react';
...
const carpentryServices = servicesData.filter(service => service.category === 'Carpentry');

// Group services by subcategory
const groupedServices = carpentryServices.reduce((acc, service) => {
    ...
    <div className="relative">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto mt-16">
          ...
          >
            Expert carpentry services for your home and business, from custom shelving to furniture repairs. Get high-quality craftsmanship tailored to your needs.
          </motion.p>
          <motion.button
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              <motion.div
                ...
                transition={{ delay: 0.2 }}
              >
                <h2 className="text-3xl font-bold mb-6 text-[#1B4332]">Expert Carpentry Services</h2>
                <p className="text-xl text-gray-800 mb-6">
                  Handyman Wannabe provides professional carpentry services to enhance the functionality and aesthetics of your space. Whether you need furniture repairs, custom shelving, or trim installation, our skilled craftsmen ensure precision and durability.
                </p>
                <p className="text-lg text-gray-700">
                  With years of experience and a commitment to quality, our team brings expertise and attention to detail to every project, big or small.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16">Our Carpentry Services</h2>
                ...
                >
                  ...
                  >
                    <div className="relative h-48">
                      <img
                        src={services[0]?.image || "https://images.unsplash.com/photo-1617104551722-3b2d51366400?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"}
                        alt={info.title}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Get your carpentry projects done in just a few simple steps. Professional service, guaranteed satisfaction.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                answer: "Project duration varies based on complexity. Simple repairs might take 1-2 hours, while custom installations could take several days. We'll provide a detailed timeline during the quote."
              },
              {
                question: "Do you provide warranties for carpentry work?",
                answer: "Yes, all our carpentry work comes with a satisfaction guarantee and warranty. The specific warranty period depends on the type of work performed."
              },
              {
                question: "What types of wood do you work with?",
                answer: "We work with all types of wood, including hardwoods, softwoods, and engineered wood products. We'll recommend the best material for your specific project and budget."
              },
              {
                question: "Can you match existing woodwork in my home?",
                answer: "Yes, our skilled carpenters can match existing woodwork, including trim, molding, and cabinetry. We'll ensure the new work seamlessly integrates with your home's current style."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">Ready to Start Your Carpentry Project?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get expert carpentry services from our skilled professionals. Contact us today for a free quote!
          </p>
