...
import { Star, Lightbulb, Shield, ThumbsUp, Phone, MessageSquare, ChevronDown, ChevronUp, ClipboardList, UserCheck, Calendar, ChevronRight, Timer, Home, Gift, Palette } from 'lucide-react';
...
const holidayLightingServices = servicesData.filter(service => service.category === 'Holiday Lighting');

// Group services by subcategory
const groupedServices = holidayLightingServices.reduce((acc, service) => {
...
const HolidayLightingPage = () => {
  ...
  const subcategoryInfo = {
    'exterior-holiday-lighting-installation': {
      ...
      description: 'Professional outdoor holiday lighting installation services.',
      icon: Lightbulb
    },
    ...
    <div className="relative">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        <div 
          ...
          style={{
            backgroundImage: 'url("https://images.unsplash.com/photo-1545321288-d6a54310b23a?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjJ8fENocmlzdG1hcyUyMExpZ2h0aW5nfGVufDB8fDB8fHww")',
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto mt-16">
          ...
          >
            Make your home or business shine this holiday season with professional holiday lighting installation. Our experts create stunning displays that are safe, beautiful, and hassle-free.
          </motion.p>
          <motion.button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              >
                <iframe
                  ...
                  title="Holiday Lighting Services Overview"
              ...
              <motion.div
                ...
                transition={{ delay: 0.2 }}
              >
                <h2 className="text-3xl font-bold mb-6 text-[#1B4332]">Expert Holiday Lighting Services</h2>
                <p className="text-xl text-gray-800 mb-6">
                  Handyman Wannabe provides professional holiday lighting services to brighten your home or business with stunning, festive displays. From custom designs to full installation and takedown, we ensure your holiday lighting is safe, secure, and breathtaking.
                </p>
                <p className="text-lg text-gray-700">
                  With experienced professionals and high-quality materials, we create magical holiday displays that bring joy to your community.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16">Our Holiday Lighting Services</h2>
                ...
                >
                  ...
                  >
                    <div className="relative h-48">
                      <img
                        src={services[0]?.image || "https://images.unsplash.com/photo-1545321288-d6a54310b23a?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjJ8fENocmlzdG1hcyUyMExpZ2h0aW5nfGVufDB8fDB8fHww"}
                        alt={info.title}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Get your holiday lighting installed in just a few simple steps. Professional service, guaranteed satisfaction.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              {
                question: "Can I customize the colors and design of my holiday lighting?",
                answer: "Yes, we offer custom lighting themes and color choices. Our team will work with you to create a display that matches your vision and complements your property."
              },
              {
                question: "Do you provide the holiday lights, or do I need to supply my own?",
                answer: "We can provide professional-grade holiday lights and decorations, or we can install lights you already own. Our team ensures proper installation regardless of the source."
              },
              {
                question: "How long does installation take?",
                answer: "Most residential installations take 2-4 hours, depending on the size and complexity of the display. Commercial installations may take longer based on scope."
              },
              {
                question: "Can you install lights on tall trees and hard-to-reach areas?",
                answer: "Yes, our team has the proper equipment and training to safely install lights on tall trees, high rooflines, and other hard-to-reach areas."
              },
              {
                question: "Do you offer holiday light takedown services?",
                answer: "Yes, we provide complete takedown services after the season, including careful removal, organization, and storage preparation of all decorations."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">Ready to Light Up Your Holidays?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get expert holiday lighting services from our skilled professionals. Contact us today for a free quote!
          </p>
