...
import { MapPin, Phone, Search, AlertCircle, CheckCircle2, XCircle, ChevronDown, ChevronUp, MessageSquare } from 'lucide-react';
          ...
          <div className="max-w-6xl mx-auto">
              ...
              >
                {searchStatus === 'available' ? (
                  ...
                  <>
                    ...
                    Sorry, we don't currently service your area. Please contact us for options.
                  </>
                )}
              </motion.div>
            )}
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <div className="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden mb-8">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d387193.30591910525!2d-74.25986432970721!3d40.69714941680757!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xc80b8f06e177fe62!2sNew%20York%2C%20NY!5e0!3m2!1sen!2sus!4v1645564756836!5m2!1sen!2sus"
                  width="100%"
                  height="450"
                  style={{ border: 0 }}
                  allowFullScreen
                    ...
                    {activeRegion === region.name && (
                      <div className="px-6 py-4 bg-white">
                        <div className="mb-2">
                          ...
                          <span className="ml-2 text-primary font-medium">{region.coverage}</span>
                        </div>
                        <ul className="space-y-2">
                          {region.areas.map((area) => (
                            <li key={area} className="text-gray-600 flex items-center">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Let us help you with your home improvement needs. Our expert team is ready to serve you!
            </p>
