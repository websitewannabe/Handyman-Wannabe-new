              ...
              <div className={`max-w-md mx-auto p-4 rounded-lg ${
                ...
                {searchStatus === "available" ? (
                  <div className="flex items-center">
                    ...
                    <p>Great news! We service your area.</p>
                  </div>
                  <button className="mt-3 w-full bg-primary text-white px-4 py-2 rounded hover:bg-primary/90 transition-colors">
                    Request Service Now
                  </button>
                ) : (
                  <div className="flex items-center">
                    ...
                    <p>Sorry, we don't currently service your area. Please contact us for options.</p>
                  </div>
                )}
              </div>
            )}
