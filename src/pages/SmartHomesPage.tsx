...
import { Star, Home, Shield, ThumbsUp, Phone, MessageSquare, ChevronDown, ChevronUp, ClipboardList, UserCheck, Calendar, ChevronRight, Camera, Lightbulb, Tv, Zap, Wifi, Laptop, Smartphone, Settings } from 'lucide-react';
...
const smartHomeServices = servicesData.filter(service => service.category === 'Smart Home');

// Group services by subcategory
const groupedServices = smartHomeServices.reduce((acc, service) => {
...
const SmartHomesPage = () => {
  ...
  const subcategoryInfo = {
    'smart-security-surveillance': {
      ...
      description: 'Professional installation of smart security cameras and monitoring systems.',
      icon: Camera
    },
    'smart-lighting-electrical': {
      title: 'Smart Lighting & Electrical',
      description: 'Automate and control your home lighting with smart solutions.',
      icon: Lightbulb
    },
    'smart-thermostats-climate': {
      title: 'Smart Thermostats & Climate Control',
      description: 'Efficient climate control with smart thermostats and sensors.',
      icon: Zap
    },
    'smart-entertainment-theater': {
      title: 'Smart Entertainment & Home Theater Setup',
      description: 'Professional home theater and entertainment system installation.',
      icon: Tv
    },
    'smart-home-automation': {
      title: 'Smart Home Automation & Voice Control',
      description: 'Comprehensive home automation with voice control integration.',
      icon: Home
    },
    ...
    <div className="relative">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        <div 
          ...
          style={{
            backgroundImage: 'url("https://images.unsplash.com/photo-1558002038-1055907df827?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80")',
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto mt-16">
          ...
          >
            Upgrade your home with the latest smart technology. From security cameras to home automation, our expert technicians ensure seamless setup and integration.
          </motion.p>
          <motion.button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              >
                <iframe
                  ...
                  title="Smart Home Services Overview"
              ...
              <motion.div
                ...
                transition={{ delay: 0.2 }}
              >
                <h2 className="text-3xl font-bold mb-6 text-[#1B4332]">Expert Smart Home Services</h2>
                <p className="text-xl text-gray-800 mb-6">
                  Handyman Wannabe specializes in Smart Home installations that enhance convenience, security, and energy efficiency. Whether you need a smart thermostat, video doorbell, or a fully integrated home automation system, we provide expert installation and setup tailored to your needs.
                </p>
                <p className="text-lg text-gray-700">
                  Our certified technicians stay up-to-date with the latest smart home technologies to deliver seamless integration and optimal performance for your connected home.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16">Our Smart Home Services</h2>
                ...
                >
                  ...
                  >
                    <div className="relative h-48">
                      <img
                        src={services[0]?.image || "https://images.unsplash.com/photo-1558002038-1055907df827?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"}
                        alt={info.title}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Get your smart home setup done in just a few simple steps. Professional service, guaranteed satisfaction.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                answer: "Most smart home devices are wireless, but some may require minor electrical work for installation. Our technicians will assess your needs during the consultation and explain any necessary modifications."
              },
              {
                question: "Can I control all my smart devices with one app?",
                answer: "Yes, we can help integrate multiple devices into a single smart home platform like Alexa, Google Home, or Apple HomeKit. This allows you to control all your smart devices from one central app."
              },
              {
                question: "Do you provide smart home consultations?",
                answer: "Yes, we offer expert advice on selecting the best smart home solutions for your needs. Our technicians can assess your home and recommend the most suitable devices and systems."
              },
              {
                question: "Do you offer ongoing support for smart home setups?",
                answer: "Yes, we provide troubleshooting and maintenance services to keep your smart home running smoothly. We can help with software updates, device reconfiguration, and resolving any connectivity issues."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get expert smart home services from our skilled professionals. Contact us today for a free quote!
          </p>
